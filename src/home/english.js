...
export default function HomeEnglish() {
  return (
    <div>
      ...
      <p>
        Well, either way, times have changed.  After taking AP Programming in my high school and being introduced to object-oriented design, I discovered what a wide, wide world computer science really is.  I interned at NIH, where I wrote actually-used software, and so became even further exposed to the world of programming.  In 2005, I released my first application, lineaksetup, a configuration utility for the <a href="http://lineak.sourceforge.net">LinEAK</a> project.
      </p>

      <p>
        I went to university at <a href="http://northeastern.edu">Northeastern University</a> in Boston, where I majored in Computer Science.  I did research with the High Performance Computing group there, doing work on low-level user-level process checkpointing.
      </p>

      <p>
        During the second half of 2008, I participated in a six-month co-op with Amazon.com, where I was a part of the Client Experience Analytics team.  This was a remarkable experience, where I was given a high level of autonomy and was tasked with designing and building services and pieces of infrastructure on my own.  I emerged from this a far better developer, I believe.
      </p>

      <p>
        For the fall of 2009, I went to <a href="http://www.obirin.ac.jp/en">J.F. Oberlin University</a> in Tokyo, Japan to study abroad.  At the university, I studied the Japanese language and Japanese culture, with the possible goal of returning to Japan to work or live for some period of time in the future.  I find Japan very interesting, and I would love to combine my skills and interest in Computer Science with my interest of Japan.
      </p>

      <p>
        For the second half of 2010, I returned to Amazon.com, where I worked on another internal team, the Software Deployment team.  Here, I was tasked with designing, developing, and defending an entirely new system and infrastructure.  I learned a lot about good design, and again had to work with a great deal of autonomy.
      </p>
      ...
      <p>
        I continue to love learning new technologies and approaches, and look forward to lots of new problems!
      </p>
    </div>
  );
}
